package dbm.crashingtimelines.dbmtc.projectiles;
...
public abstract class BasicBlast extends EntityFireball{
	...
	public BasicBlast(World p_i1761_1_, EntityLivingBase p_i1761_2_, double p_i1761_3_, double p_i1761_5_,
			double p_i1761_7_) {
		super(p_i1761_1_);
	...
	protected void onImpact1(MovingObjectPosition p_70227_1_) {
	...
	public void onUpdate()
    {
        ...
        else
        {
            ...
            if (movingobjectposition != null)
            {
                this.onImpact1(movingobjectposition);
            }
